...
| Sizing | Kelly on LIVE sub-account equity (available+locked mirror); `capital_inr` is P&L baseline only — Decision 025 (amends 015). Indian buckets cap sizing equity at `capital_inr`+adjustments (no Dhan sub-accounts) — Decision 027 |
